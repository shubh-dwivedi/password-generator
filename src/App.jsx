    ...
    <div className='w-full h-fit flex flex-col justify-center-safe pt-6 px-2'>
      <div className='md:w-xl sm:w-lg max-sm:w-full shadow-md rounded-lg px-4 py-4 my-6 bg-gray-700 mx-auto text-center'>
        ...
        <div className='flex max-sm:flex-col max-sm:gap-3 justify-between shadow p-3 rounded-lg overflow-hidden mb-4 bg-gray-600'>
          ...
          <button id='btn-reload' className='bg-blue-400 max-sm:hidden text-white px-3 rounded-lg shrink-0 ml-2' title='Regenerate' onClick={passwordGenerator}><img src={reload} alt="reload" className='w-6'/></button>
          ...
          <div className='flex justify-between min-sm:hidden '>
            ...
            <div className='flex justify-end-safe'>
              ...
              <button id='btn-reload' className='bg-blue-400 w-fit text-white px-3 py-2.5 rounded-lg shrink-0 ml-2' title='Regenerate' onClick={passwordGenerator}><img src={reload} alt="reload" className='w-6'/></button>
            </div>
          </div>
        </div>
